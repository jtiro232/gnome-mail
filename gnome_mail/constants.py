...
APP_NAME = "Gnome Mail"
COMPOSE_TITLE = "Scribe a Scroll"
SEND_BUTTON = "Send by Toadstool Express"
...
YOU_LABEL = "You Wrote"
RESPONSE_LABEL_TEMPLATE = "{} responded from the hollow tree"
LOAD_MORE = "Dig deeper in the mushroom patch..."
TOAST_ERROR_TEMPLATE = "Oh no! The gnome couldn't reach {}"
TOAST_RECEIVED_TEMPLATE = "A new scroll arrived from {}"
WAITING_RESPONSE = "Don't Fret! The Gnome Snails are delivering your message with haste!"
EMPTY_MESSAGE_WARNING = "The scroll is blank! A gnome cannot deliver nothing."
